...
install-flatpak-web:
	$(FLATPAK_BUILDER) --user --install build flatpak/web/org.nanuc.Axolotl.yml --force-clean

install-flatpak-qt:
	$(FLATPAK_BUILDER) --user --install build flatpak/qt/org.nanuc.Axolotl.yml --force-clean
